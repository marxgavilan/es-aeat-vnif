...
### Fixed
- Compatibilidad con PHP 8.2: las constantes de protocolos de cURL de PHP 8.3 se leen solo si existen.
...
[1.1.1]: https://github.com/marxgavilan/es-aeat-vnif/releases/tag/v1.1.1
